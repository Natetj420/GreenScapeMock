...
// ---------------- constants hoisted ------------------
export const NAV_LINKS = ["Home", "Services", "Portfolio", "About", "Contact"];
  ...
  return (
    <div className="bg-green-50 text-green-900 font-sans">
      ...
      <nav className="relative sticky top-0 z-50 bg-gradient-to-r from-green-100 via-green-200 to-green-100 shadow-md animate-navbar-shimmer bg-[length:400%_100%]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center space-x-3">
            <img src={logoUrl} alt="Maple Summit Landscape Logo" className="h-10 w-auto object-contain" />
            <span className="text-2xl font-bold text-green-800 drop-shadow-sm">Maple Summit Landscape</span>
          </Link>
          ...
          >
            {menuOpen ? <HiOutlineXMark size={28} /> : <HiOutlineMenu size={28} />}
          </button>
        </div>
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
        <img
          src="/assets/images/hero-1600.webp"
          srcSet="/assets/images/hero-600.webp 600w, /assets/images/hero-1200.webp 1200w, /assets/images/hero-1600.webp 1600w"
          sizes="(max-width:640px) 100vw, (max-width:1024px) 100vw, 100vw"
          alt="Beautiful landscaped backyard with fresh greenery"
          className="absolute inset-0 w-full h-full object-cover z-0"
          loading="eager"
          decoding="async"
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-green-900/40 z-10" />
        <motion.div
      ...
      >
          <img
    src="/assets/images/about-1600.webp"
    srcSet="
      /assets/images/about-600.webp   600w,
      /assets/images/about-1200.webp 1200w,
      /assets/images/about-1600.webp 1600w
    "
    sizes="(max-width:640px) 100vw,
           (max-width:1024px) 100vw,
           100vw"
    alt="Beautiful trimmed boxwoods"
    className="absolute inset-0 w-full h-full object-cover z-0"
    loading="eager"
    decoding="async"
  />
        ...
        >
          <h3 className="text-4xl md:text-5xl font-extrabold mb-6 text-white drop-shadow-lg">About Maple Summit Landscape</h3>
          <p className="text-lg md:text-xl mb-6 leading-relaxed text-white drop-shadow-md">
            At Maple Summit Landscape , we’ve been crafting beautiful, sustainable landscapes for over a decade. Whether you need maintenance or a full transformation, we bring passion, experience, and care to every project.
          </p>
      ...
      <section className="bg-gradient-to-b from-green-50 to-white py-24 px-6">
        <div className="max-w-6xl mx-auto text-center mb-16">
          <h3 className="text-4xl font-extrabold text-green-800 mb-4 tracking-tight drop-shadow-sm">Why Choose Maple Summit Landscape?</h3>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {[...Array(2)].flatMap(() => [
                { name: "Sophie M.", quote: "Maple Summit Landscape turned our backyard into a dream space.", location: "Surrey, BC", rating: 5 },
      ...
      <footer className="bg-green-900 text-white pt-16 pb-8 px-6">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h4 className="text-xl font-bold mb-4">Maple Summit Landscape</h4>
        ...
        <div className="border-t border-green-700 mt-12 pt-6 text-center text-sm text-green-100">
          <p>© {new Date().getFullYear()} Maple Summit Landscape. All rights reserved.</p>
